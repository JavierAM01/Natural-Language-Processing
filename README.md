...
| <p align="center">[<img width="3000" height="250" src="https://github.com/JavierAM01/LoRA-GPT2-Parameter-Efficient-Fine-Tuning-for-Sentiment-Analysis/blob/main/images/lora.png">](https://github.com/JavierAM01/LoRA-GPT2-Parameter-Efficient-Fine-Tuning-for-Sentiment-Analysis)</p> | **:boom: Fine-Tunning GPT2 with LoRA :boom:** This repository implements Low-Rank Adaptation (LoRA), a Parameter-Efficient Fine-Tuning (PEFT) method, to efficiently fine-tune a pre-trained GPT-2 model. <p align="center"><a href="https://github.com/JavierAM01/LoRA-GPT2-Parameter-Efficient-Fine-Tuning-for-Sentiment-Analysis">See details</a></p> |
